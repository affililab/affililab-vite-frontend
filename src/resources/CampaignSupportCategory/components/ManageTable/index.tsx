...
export const ManageTable = () => {
    ...
    useEffect(() => {
        setCenterItems([<SearchInput placeholder={"Suche Campaign Support Categories ..."} searchValue={resourceData.searchValue} updateInput={resourceData.setSearchValue} key={1} />]);
    }, []);
