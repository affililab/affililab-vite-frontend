...
export const ManageTable = () => {
    ...
    useEffect(() => {
        setCenterItems([<SearchInput placeholder={"Suche E-Learning Resources Types ..."} searchValue={resourceData.searchValue} updateInput={resourceData.setSearchValue} key={1} />]);
    }, []);
